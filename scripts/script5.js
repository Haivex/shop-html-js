function isEmptyOrSpaces(str){
    return str === null || str.match(/^ *$/) !== null;
        ...
        else
        {
         ...
         function createSimilarItem(itemindex)
         {    
        ...
        logoimg.src = document.getElementsByClassName("itemfamiliarlogo")[itemindex-1].src;
        ...
        itemdescription.innerHTML = document.getElementsByClassName("namefamiliar")[itemindex-1].textContent;
        itemname.appendChild(itemdescription);

        var itemprice = document.createElement("div");
        itemprice.setAttribute("class", "price");
        itemprice.setAttribute("id", "price"+identificator);
        itemprice.innerHTML = document.getElementsByClassName("pricefamiliar")[itemindex-1].textContent;
