...
function addWishlist(itemindex, page)
{
    if(document.getElementById("account").style.display == 'block')
    {
   var staricon =  document.getElementsByClassName("wishlist-icon")[itemindex];
   if(staricon.classList.contains("far"))
   {
   staricon.classList.replace("far", "fas");
    var wishlisttext = document.getElementsByClassName("wishlist-text")[itemindex];
...
function loadWishlist(itemindex, page)
                {
                    var staricon =  document.getElementsByClassName("wishlist-icon")[itemindex];
